...
add_custom_command(
    ...
    COMMAND ${Python3_EXECUTABLE} ${CMAKE_PREFIX_PATH}/bin/sip-module --sdist --target-dir ${CMAKE_PREFIX_PATH}/lib/python3.5 sip5
    COMMAND ${Python3_EXECUTABLE} -m pip install ${CMAKE_PREFIX_PATH}/lib/python3.5/sip5-12.8.1.tar.gz
    COMMAND ${Python3_EXECUTABLE} ${CMAKE_PREFIX_PATH}/bin/sip-module --sip-h --target-dir ${CMAKE_PREFIX_PATH}/include/python3.5 sip5
)
